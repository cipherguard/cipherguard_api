...
/**
 * This class extends the CakePHP belongs to many class and add to it additional behavior required by cipherguard.
 *
 ...
 * @mixin T
 */
class CipherguardBelongsToMany extends BelongsToMany
{
    /**
