...
abstract class AbstractGpgHealthcheck implements HealthcheckServiceInterface, HealthcheckCliInterface
{
    ...
    {
        return Configure::read('cipherguard.gpg.serverKey.fingerprint');
    }
    ...
    {
        return Configure::read('cipherguard.gpg.serverKey.public');
    }
    ...
    {
        return Configure::read('cipherguard.gpg.serverKey.private');
    }
    ...
    {
        return Configure::read('cipherguard.gpg.serverKey.passphrase');
    }
