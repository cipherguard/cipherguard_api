...
class JsProdApplicationHealthcheck implements HealthcheckServiceInterface, HealthcheckCliInterface
{
    ...
    {
        $this->status = (Configure::read('cipherguard.js.build') === 'production');
    ...
    {
        return __('Using non-compiled Javascript. Cipherguard will be slower.');
    }
    ...
    {
        return __('Set cipherguard.js.build to production in {0}', CONFIG . 'cipherguard.php');
    }
