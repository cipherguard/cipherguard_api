...
class SslForceApplicationHealthcheck implements HealthcheckServiceInterface, HealthcheckCliInterface
{
    ...
    {
        $this->status = Configure::read('cipherguard.ssl.force');
    ...
    {
        return __('Cipherguard is configured to force SSL use.');
    }
    ...
    {
        return __('Cipherguard is not configured to force SSL use.');
    }
    ...
    {
        return __('Set cipherguard.ssl.force to true in {0}.', CONFIG . 'cipherguard.php');
    }
