...
class SelfRegistrationPublicRemovedApplicationHealthcheck implements HealthcheckServiceInterface, HealthcheckCliInterface // phpcs:ignore
{
    ...
    public function check(): HealthcheckServiceInterface
    {
        ...
        $this->status = $selfRegistrationChecks['isRegistrationPublicRemovedFromCipherguard'];
    ...
    {
        return __('The deprecated self registration public setting was not found in {0}.', CONFIG . 'cipherguard.php');
    }
    ...
    {
        return __('The deprecated self registration public setting was found in {0}.', CONFIG . 'cipherguard.php');
    }
    ...
    {
        return __('You may remove the "cipherguard.registration.public" setting.');
    }
    ...
    {
        return 'registrationClosed.isRegistrationPublicRemovedFromCipherguard';
    }
}
