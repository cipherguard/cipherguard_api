...
class UsersTable extends Table
{
    ...
    /**
     * If false (default), username are not case-sensitive: john@cipherguard.com and John@cipherguard.com cannot be both not-deleted
     * If true, username is case-sensitive: john@cipherguard.com and John@cipherguard.com can both be not-deleted
     *
     * @return bool
     */
