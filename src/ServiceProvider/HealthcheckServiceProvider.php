...
use App\Service\Healthcheck\ConfigFiles\CipherguardConfigFileHealthcheck;
...
class HealthcheckServiceProvider extends ServiceProvider
{
    protected $provides = [
        ...
        CipherguardConfigFileHealthcheck::class,
    ...
    public function services(ContainerInterface $container): void
    {
        ...
        $container->add(CipherguardConfigFileHealthcheck::class);
        // Core health checks
        ...
        $container->add(HealthcheckServiceCollector::class)
            ...
            ->addMethodCall('addService', [CipherguardConfigFileHealthcheck::class])
