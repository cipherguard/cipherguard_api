 ...
 * Cipherguard command.
 */
class CipherguardCommand extends Command implements CipherguardCommandInterface
{
    ...
    private ?CommandCollection $cipherguardCommandCollection;

    /**
     * @param \Cake\Console\CommandCollection|null $cipherguardCommandCollection Collection of commands used to display the list of cipherguard commands
     * @see CipherguardBuildCommandsListener
     */
    public function __construct(?CommandCollection $cipherguardCommandCollection = null)
    {
        parent::__construct();
        $this->cipherguardCommandCollection = $cipherguardCommandCollection;
    }
    ...
    {
        return __('The Cipherguard CLI offers an access to the cipherguard API directly from the console.');
    }
    ...
    public function buildOptionParser(ConsoleOptionParser $parser): ConsoleOptionParser
    {
        ...
        if (!isset($this->cipherguardCommandCollection)) {
            return $parser;
        }

        // Append the help message as options of all the cipherguard commands
        foreach ($this->cipherguardCommandCollection as $name => $commandFQN) {
            if (is_a($commandFQN, CipherguardCommandInterface::class, true)) {
                /** @var \App\Command\CipherguardCommandInterface $commandFQN */
    ...
    /**
     * Some of the cipherguard commands shouldn't be executed as root.
     ...
     */
    public function getCipherguardCommandCollection(): ?CommandCollection
    {
        return $this->cipherguardCommandCollection;
    }
}
