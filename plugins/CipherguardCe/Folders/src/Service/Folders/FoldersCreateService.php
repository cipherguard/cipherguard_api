...
class FoldersCreateService
{
     ...
     * @param \Cipherguard\Metadata\Model\Dto\MetadataFolderDto $folderDto The folder DTO.
     ...
     * @param \App\Utility\UserAccessControl $uac The current user
     * @param \Cipherguard\Folders\Model\Entity\Folder $folder The folder
     * @param \Cipherguard\Metadata\Model\Dto\MetadataFolderDto $folderDto Folder DTO.
