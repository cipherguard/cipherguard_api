...
class FoldersUpdateServiceTest extends FoldersTestCase
{
    ...
    public function testUpdateFolderSuccess_NotifyUserAfterUpdate()
    {
        ...
        $this->assertEmailSubject('ada@cipherguard.com', "You edited the folder $name");
        $this->assertEmailInBatchContains('You edited a folder', 'ada@cipherguard.com');
        $this->assertEmailSubject('betty@cipherguard.com', "Ada edited the folder $name");
        $this->assertEmailInBatchContains('Ada edited a folder', 'betty@cipherguard.com');
    }
