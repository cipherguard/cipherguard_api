...
class FoldersShareServiceTest extends FoldersTestCase
{
    ...
    public function testShareFolderSuccess_NotifyUserAfterShare()
    {
        ...
        $this->assertEmailSubject('betty@cipherguard.com', 'Ada shared the folder A');
        $this->assertEmailInBatchContains('Ada shared a folder with you', 'carol@cipherguard.com');
        $this->assertEmailSubject('carol@cipherguard.com', 'Ada shared the folder A');
        $this->assertEmailInBatchContains('Ada shared a folder with you', 'betty@cipherguard.com');
    }
