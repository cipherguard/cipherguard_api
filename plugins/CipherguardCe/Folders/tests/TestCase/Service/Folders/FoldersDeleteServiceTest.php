...
class FoldersDeleteServiceTest extends FoldersTestCase
{
    ...
    public function testFolderDelete_CommonSuccess2_NotifyUsersAfterDelete()
    {
        ...
        $this->assertEmailSubject('ada@cipherguard.com', 'You deleted the folder A');
        $this->assertEmailInBatchContains('You deleted a folder', 'ada@cipherguard.com');
        $this->assertEmailSubject('betty@cipherguard.com', 'Ada deleted the folder A');
        $this->assertEmailInBatchContains('Ada deleted a folder', 'betty@cipherguard.com');
    }
