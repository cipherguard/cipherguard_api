...
class PasswordExpirySettingsUpdatedEmailRedactor implements SubscribedEmailRedactorInterface
{
     ...
     * @var string
     */
    public const TEMPLATE = 'Cipherguard/PasswordExpiry.AD/settings_updated';
     ...
     * @param \Cipherguard\PasswordExpiry\Model\Entity\PasswordExpirySetting $passwordExpirySetting The Password expiry settings.
