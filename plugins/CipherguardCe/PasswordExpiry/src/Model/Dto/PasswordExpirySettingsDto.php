 ...
 * @since         4.5.0
 */
namespace Cipherguard\PasswordExpiry\Model\Dto;
...
class PasswordExpirySettingsDto
{
     ...
     *
     * @param \Cipherguard\PasswordExpiry\Model\Entity\PasswordExpirySetting $passwordExpirySetting Entity object to create DTO from.
     * @param \Cipherguard\PasswordExpiry\Form\PasswordExpirySettingsForm $form Form having validated and modified the data.
     * @return self
     */
