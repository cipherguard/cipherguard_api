 ...
 * @property \Cipherguard\Metadata\Model\Table\MetadataPrivateKeysTable&\Cake\ORM\Association\HasMany $MetadataPrivateKeys
 * @method \Cipherguard\Metadata\Model\Entity\MetadataKey newEmptyEntity()
 * @method \Cipherguard\Metadata\Model\Entity\MetadataKey newEntity(array $data, array $options = [])
 * @method \Cipherguard\Metadata\Model\Entity\MetadataKey[] newEntities(array $data, array $options = [])
 * @method \Cipherguard\Metadata\Model\Entity\MetadataKey get($primaryKey, $options = [])
 * @method \Cipherguard\Metadata\Model\Entity\MetadataKey findOrCreate($search, ?callable $callback = null, $options = [])
 * @method \Cipherguard\Metadata\Model\Entity\MetadataKey patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \Cipherguard\Metadata\Model\Entity\MetadataKey[] patchEntities(iterable $entities, array $data, array $options = [])
 * @method \Cipherguard\Metadata\Model\Entity\MetadataKey|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \Cipherguard\Metadata\Model\Entity\MetadataKey[]|iterable<mixed, \Cake\Datasource\EntityInterface>|false saveMany(iterable $entities, $options = [])
 * @method \Cipherguard\Metadata\Model\Entity\MetadataKey[]|iterable<mixed, \Cake\Datasource\EntityInterface> saveManyOrFail(iterable $entities, $options = [])
 * @method \Cipherguard\Metadata\Model\Entity\MetadataKey[]|iterable<mixed, \Cake\Datasource\EntityInterface>|false deleteMany(iterable $entities, $options = [])
 * @method \Cipherguard\Metadata\Model\Entity\MetadataKey[]|iterable<mixed, \Cake\Datasource\EntityInterface> deleteManyOrFail(iterable $entities, $options = [])
...
class MetadataKeysTable extends Table
{
    ...
    public function initialize(array $config): void
    {
        ...
        $this->hasMany('MetadataPrivateKeys', [
            ...
            'className' => 'Cipherguard/Metadata.MetadataPrivateKeys',
        ]);
