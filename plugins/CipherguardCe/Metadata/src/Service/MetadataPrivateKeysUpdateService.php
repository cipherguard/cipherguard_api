...
use Cipherguard\Metadata\Model\Table\MetadataPrivateKeysTable;
...
class MetadataPrivateKeysUpdateService
{
     ...
     * @return \Cipherguard\Metadata\Model\Entity\MetadataPrivateKey
     */
    public function update(UserAccessControl $uac, string $privateKeyId, array $data): MetadataPrivateKey
    {
        ...
        /** @var \Cipherguard\Metadata\Model\Table\MetadataPrivateKeysTable $metadataPrivateKeysTable */
        $metadataPrivateKeysTable = $this->fetchTable('Cipherguard/Metadata.MetadataPrivateKeys');
        try {
            /** @var \Cipherguard\Metadata\Model\Entity\MetadataPrivateKey $metadataPrivateKey */
     ...
     *
     * @param \Cipherguard\Metadata\Model\Entity\MetadataPrivateKey $entity that is failing the validation
     * @param \Cipherguard\Metadata\Model\Table\MetadataPrivateKeysTable $table table
