 ...
 * @since         4.10.0
 */
namespace Cipherguard\Metadata\Form;
...
{
    public const CIPHERGUARD_METADATA_PRIVATE_KEY = 'CIPHERGUARD_METADATA_PRIVATE_KEY';
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $sslForce = Configure::read('cipherguard.ssl.force') ?? true;
        ...
        if (Configure::read('cipherguard.security.checkDomainMismatch')) {
            $validator
                ->add('domain', 'equals', [
                    'last' => true,
    ...
    /**
     * Check true if object type equals CIPHERGUARD_METADATA_PRIVATE_KEY
     *
    ...
    {
        return $check === self::CIPHERGUARD_METADATA_PRIVATE_KEY;
    }
