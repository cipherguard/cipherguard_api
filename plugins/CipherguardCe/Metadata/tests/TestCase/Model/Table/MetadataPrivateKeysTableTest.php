...
/**
 * @covers \Cipherguard\Metadata\Model\Table\MetadataPrivateKeysTable
 */
class MetadataPrivateKeysTableTest extends AppTestCaseV5
{
     ...
     * Test subject
     *
     * @var \Cipherguard\Metadata\Model\Table\MetadataPrivateKeysTable
     */
    ...
    public function setUp(): void
    {
        ...
        $this->MetadataPrivateKeys = TableRegistry::getTableLocator()->get('Cipherguard/Metadata.MetadataPrivateKeys');
    }
    ...
    /**
     * @return void
     * @uses \Cipherguard\Metadata\Model\Table\MetadataPrivateKeysTable::validationDefault()
     */
    ...
    /**
     * @return void
     * @uses \Cipherguard\Metadata\Model\Table\MetadataPrivateKeysTable::buildRules()
     */
    ...
    {
        /** @var \Cipherguard\Metadata\Model\Entity\MetadataPrivateKey $key */
