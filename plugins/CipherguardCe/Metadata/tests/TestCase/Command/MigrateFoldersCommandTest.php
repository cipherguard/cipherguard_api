 ...
 * @since         4.10.0
 */
namespace Cipherguard\Metadata\Test\TestCase\Command;
...
/**
 * @covers \Cipherguard\Metadata\Command\MigrateFoldersCommand
 */
class MigrateFoldersCommandTest extends AppIntegrationTestCaseV5
{
    ...
    {
        $this->exec('cipherguard metadata migrate_folders -h');

        $this->assertExitSuccess();
        $this->assertOutputContains('Migrate V4 folders to V5.');
        $this->assertOutputContains('cake cipherguard metadata migrate_folders');
    }
    ...
    public function testMigrateFoldersCommand_Success_MultipleFolders(): void
    {
        ...
        $this->exec('cipherguard metadata migrate_folders');
        ...
        // Personal folder of Ada
        /** @var \Cipherguard\Folders\Model\Entity\Folder $updatedFolder1 */
        ...
        /** @var \Cipherguard\Folders\Model\Entity\Folder $updatedFolder2 */
