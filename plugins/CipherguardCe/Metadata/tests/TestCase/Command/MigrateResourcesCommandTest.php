...
/**
 * @covers \Cipherguard\Metadata\Command\MigrateResourcesCommand
 */
class MigrateResourcesCommandTest extends AppIntegrationTestCaseV5
{
    ...
    {
        $this->exec('cipherguard metadata migrate_resources -h');

        $this->assertExitSuccess();
        $this->assertOutputContains('Migrate V4 resources to V5.');
        $this->assertOutputContains('cake cipherguard metadata migrate_resources');
    }
    ...
    public function testMigrateResourcesCommand_Success_MultipleResources(): void
    {
        ...
        $this->exec('cipherguard metadata migrate_resources');
