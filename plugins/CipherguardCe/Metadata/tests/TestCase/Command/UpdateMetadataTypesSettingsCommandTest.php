...
/**
 * @covers \Cipherguard\Metadata\Command\UpdateMetadataTypesSettingsCommand
 */
class UpdateMetadataTypesSettingsCommandTest extends AppIntegrationTestCaseV5
{
    ...
    {
        $this->exec('cipherguard metadata update_metadata_types_settings -h');

        $this->assertExitSuccess();
        $this->assertOutputContains('Create/update metadata types settings.');
        $this->assertOutputContains('cake cipherguard metadata update_metadata_types_settings');
    }
    ...
    public function testUpdateMetadataTypesSettingsCommand_Success_UpgradeResourcesToV5(): void
    {
        ...
        $this->exec("cipherguard metadata update_metadata_types_settings {$options}");
    ...
    public function testUpdateMetadataTypesSettingsCommand_Error_NoDataProvided(): void
    {
        ...
        $this->exec('cipherguard metadata update_metadata_types_settings --username=' . $user->get('username'));
