...
/**
 * @covers \Cipherguard\Metadata\Command\MigrateAllItemsCommand
 */
class MigrateAllItemsCommandTest extends AppIntegrationTestCaseV5
{
    ...
    {
        $this->exec('cipherguard metadata migrate_all_items -h');

        $this->assertExitSuccess();
        $this->assertOutputContains('Migrate V4 resources, folders, etc. to V5.');
        $this->assertOutputContains('cake cipherguard metadata migrate_all_items');
    }
    ...
    public function testMigrateAllItemsCommand_Success(): void
    {
        ...
        $this->exec('cipherguard metadata migrate_all_items');
