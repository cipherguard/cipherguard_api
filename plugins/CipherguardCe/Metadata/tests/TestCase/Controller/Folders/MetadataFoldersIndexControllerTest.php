...
/**
 * @covers \Cipherguard\Folders\Controller\Folders\FoldersIndexController
 */
class MetadataFoldersIndexControllerTest extends AppIntegrationTestCaseV5
{
    ...
    public function testMetadataFoldersIndexController_Success_PersonalV5AndV4Mix()
    {
        ...
        $user = UserFactory::make()
            ...
            ->persist();
        // v5 folder
        $clearTextMetadata = json_encode(['object_type' => 'CIPHERGUARD_FOLDER_METADATA', 'name' => 'Social media']);
    ...
    public function testMetadataFoldersIndexController_Success_Shared()
    {
        ...
        $clearTextMetadata = json_encode(['object_type' => 'CIPHERGUARD_FOLDER_METADATA', 'name' => 'engineering']);
        $metadata = $this->encryptForMetadataKey($clearTextMetadata);
        /** @var \Cipherguard\Folders\Model\Entity\Folder $parentFolder */
