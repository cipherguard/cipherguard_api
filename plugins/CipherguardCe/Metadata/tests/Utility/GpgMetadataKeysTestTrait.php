...
trait GpgMetadataKeysTestTrait
{
    ...
    public function getMetadataKeyInfo(): array
    {
        return [
            ...
            'email' => 'unit-tests@cipherguard.com',
        ];
    }
    ...
    public function getExpiredKeyInfo(): array
    {
        return [
            ...
            'email' => 'expired_key@cipherguard.test',
        ];
    }
    ...
    public function getInvalidAlgKeyInfo(): array
    {
        return [
            ...
            'email' => 'elgamal@cipherguard.com',
        ];
    }

    /**
     * Message encrypted for Maki (maki@cipherguard.com) and signed with server public key (unsecure.key).
     *
     * @return false|string
     */
    ...
    /**
     * Message encrypted for Maki (maki@cipherguard.com), it's different from getEncryptedMetadataPrivateKeyFoUser().
     *
     * @return false|string
     */
...
-----END PGP PRIVATE KEY BLOCK-----',
            'passphrase' => 'metadatakey@cipherguard.test',
        ];
    }
...
=A9iB
-----END PGP PRIVATE KEY BLOCK-----',
            'passphrase' => 'server_metadata_private_key@cipherguard.test',
        ];
    }
...
";
    ...
    public function getValidPrivateKeyDataForServer(): string
    {
        ...
        if (!isset(static::$keycache[$fingerprint])) {
            ...
            $gpg->setSignKeyFromFingerprint($fingerprint, Configure::read('cipherguard.gpg.serverKey.passphrase'));
