...
class EmailControllerTest extends WebInstallerIntegrationTestCase
{
    ...
    {
        $recipient = 'receiver@cipherguard.com';
        $postData = [
            'sender_name' => 'Cipherguard Test',
            'sender_email' => 'sender@cipherguard.com',
            'host' => 'unreachable_host',
            'tls' => true,
            'port' => 123,
            'authentication_method' => 'username_and_password',
        ...
        $this->assertMailSentFromAt(0, ['sender@cipherguard.com' => 'Cipherguard Test']);
    ...
    public function testWebInstallerEmailPostError_CannotSendTestEmail()
    {
        $postData = [
            ...
            'password' => 'password',
            'send_test_email' => true,
            'email_test_to' => 'test@cipherguard.com',
        ];
        $trace = [['cmd' => 'bar']];
