 ...
 * @since         4.8.0
 */
namespace Cipherguard\Log\Command;
...
use Cipherguard\Log\Service\ActionLogs\ActionLogsPurgeService;

class ActionLogsPurgeCommand extends CipherguardCommand
{
    /**
    ...
    private function getDryRun(int $retentionInDays, ConsoleIo $io): void
    {
        ...
        $data[] = ['Action', 'Count'];
        /** @var \Cipherguard\Log\Model\Entity\ActionLog $log */
        foreach ($logs as $log) {
