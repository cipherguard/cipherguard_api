...
class EntitiesHistoryFactory extends CakephpBaseFactory
{
    ...
    /**
     * @param \Cipherguard\Log\Test\Factory\ActionLogFactory|null $actionLogFactory ActionLog factory
     * @return $this
     */
    ...
    /**
     * @param \Cipherguard\Folders\Test\Factory\ResourceFactory|null $resourceFactory Resource factory
     * @return $this
     */
