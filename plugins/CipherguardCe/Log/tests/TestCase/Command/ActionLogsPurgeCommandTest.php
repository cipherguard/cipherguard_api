 ...
 * @since         4.8.0
 */
namespace Cipherguard\Log\Test\TestCase\Command;
...
class ActionLogsPurgeCommandTest extends AppIntegrationTestCase
{
    ...
    {
        $this->exec('cipherguard action_logs_purge -h');
    ...
    public function testActionLogsPurgeCommand_Purge()
    {
        ...
        ->setActionId($action)
        ->persist();
        $this->exec('cipherguard action_logs_purge -r ' . $retentionPeriodInDays);
        $this->assertExitSuccess();
    ...
    public function testActionLogsPurgeCommand_Dry_Run()
    {
        ...
        $this->exec('cipherguard action_logs_purge -d -r ' . $retentionPeriodInDays);
    ...
    public function testActionLogsPurgeCommand_NegativeValueInRetentionDaysOption(): void
    {
        ...
        $this->exec('cipherguard action_logs_purge -r -10');
    ...
    public function testActionLogsPurgeCommand_LimitOption_Success(): void
    {
        ...
        $this->exec('cipherguard action_logs_purge -r 2 -l 3');
    ...
    public function testActionLogsPurgeCommand_LimitOption_Error(): void
    {
        ...
        $this->exec('cipherguard action_logs_purge -r 2 -l -5');
