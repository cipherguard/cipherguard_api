...
class MfaOtpFactoryTest extends MfaIntegrationTestCase
{
    ...
    public function testMfaOtpFactoryGetIssuer_UrlCheck()
    {
        ...
        $issuer = MfaOtpFactory::getIssuer('http://cloud.cipherguard.com/acme');
        $this->assertTextEquals('cloud.cipherguard.com/acme', $issuer);

        $issuer = MfaOtpFactory::getIssuer('http://cloud.cipherguard.com/acme:test');
        $this->assertTextEquals('cloud.cipherguard.com/acmetest', $issuer);

        $issuer = MfaOtpFactory::getIssuer('www.cipherguard.com');
        $this->assertTextEquals('www.cipherguard.com', $issuer);
    }
    ...
    public function testMfaOtpFactoryGenerateTOTP()
    {
        ...
        $this->assertStringContainsString('ada%40cipherguard.com', $otp);
    }
