...
class LocaleServiceTest extends TestCase
{
    ...
    {
        return [
            ['fr-FR', 'Courriel envoyé de: admin@cipherguard.com'],
            ['fr_FR', 'Courriel envoyé de: admin@cipherguard.com'],
            ['en-UK', 'Sending email from: admin@cipherguard.com'],
            ['en_UK', 'Sending email from: admin@cipherguard.com'],
            ['foo_BAR', 'Sending email from: admin@cipherguard.com'],
            ['', 'Sending email from: admin@cipherguard.com'],
        ];
    }
    ...
    public function dataProviderForTestLocaleServiceLocaleTranslateString_On_Existing_Locale_French_Default(): array
    {
        return [
            ...
            ['en-UK', 'Sending email from: admin@cipherguard.com'],
            ['en_UK', 'Sending email from: admin@cipherguard.com'],
            ['foo_BAR', 'Courriel envoyé de: admin@cipherguard.com'],
            ['', 'Courriel envoyé de: admin@cipherguard.com'],
        ];
    }
    ...
    public function testLocaleServiceLocaleTranslateString(string $locale, string $expectedSubject)
    {
        ...
        $translation = $service->translateString($locale, function () {
            return __('Sending email from: {0}', 'admin@cipherguard.com');
        });
