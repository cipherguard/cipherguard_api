...
use Cipherguard\SmtpSettings\Service\SmtpSettingsSslOptionsGetService;

/**
 * @covers \Cipherguard\SmtpSettings\Service\SmtpSettingsSslOptionsGetService
 */
class SmtpSettingsSslOptionsGetServiceTest extends AppTestCase
{
    ...
    {
        Configure::write('cipherguard.plugins.smtpSettings.security', $badConfigValues);

        $this->expectException(BadRequestException::class);
        $defaultExceptionMsg = 'Invalid `cipherguard.plugins.smtpSettings.security` configuration values.' . ' ';
    ...
    {
        Configure::write('cipherguard.plugins.smtpSettings.security', ['sslVerifyPeer' => false]);
