...
class UsersAddControllerTest extends AppIntegrationTestCase
{
    ...
    public function testUsersAddController_Success(): void
    {
        ...
        $success = [
            'admin role' => [
                'username' => 'ping.fu@cipherguard.com',
                'role_id' => $adminRoleId,
                'profile' => [
                    'first_name' => '傅',
                    'last_name' => '苹',
            ...
            'user role' => [
                'username' => 'borka@cipherguard.com',
                'role_id' => $userRoleId,
                'profile' => [
                    'first_name' => 'Borka',
            ...
            'no role' => [
                'username' => 'aurore@cipherguard.com',
                'profile' => [
                    'first_name' => 'Aurore',
    ...
    public function testUsersAddController_Success_EmailSent(): void
    {
        ...
        $this->assertEmailInBatchContains('created an account for you', 'aurore@cipherguard.com');
        ...
        $this->assertEmailInBatchContains($user, 'aurore@cipherguard.com');
    }
    ...
    public function testUsersAddController_Error_NotLoggedIn(): void
    {
        ...
        $data = [
            'username' => 'notallowed@cipherguard.com',
            'profile' => [
                'first_name' => 'not',
                'last_name' => 'allowed',
            ],
