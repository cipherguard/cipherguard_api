...
class ResourcesUpdateNotificationWithStaticFixturesTest extends AppIntegrationTestCase
{
    ...
    public function testResourcesUpdateNotificationSuccess_Secrets(): void
    {
        ...
        $this->assertEmailInBatchContains('edited the resource', 'ada@cipherguard.com');
        $this->assertEmailInBatchContains('edited the resource', 'betty@cipherguard.com');
        $this->assertEmailInBatchContains('edited the resource', 'carol@cipherguard.com');
        $this->assertEmailInBatchContains('edited the resource', 'dame@cipherguard.com');
    }
}
