...
class ShareNotificationTest extends ShareControllerTest
{
    ...
    public function testShareNotificationSuccess(): void
    {
        ...
        $this->assertEmailInBatchContains('shared a password with you', 'edith@cipherguard.com');
        $this->assertEmailInBatchContains('Name: cakephp', 'edith@cipherguard.com');
        $this->assertEmailInBatchContains('Username: cake', 'edith@cipherguard.com');
        $this->assertEmailInBatchContains('The rapid and tasty php development framework', 'edith@cipherguard.com');
        $this->assertEmailInBatchContains('URL: cakephp.org', 'edith@cipherguard.com');
        $this->assertEmailInBatchContains('BEGIN PGP MESSAGE', 'edith@cipherguard.com');

        $this->assertEmailInBatchContains('shared a password with you', 'frances@cipherguard.com');
    }
}
