...
<?php if (isset($safeMode) && !$safeMode) : ?>
            <li class="error message"><a href="https://help.cipherguard.com/faq/hosting/why-unsafe" title="terms of service">Unsafe mode</a></li>
<?php endif; ?>
...
<?php endif; ?>
            <li><a href="https://www.cipherguard.com/credits"><?= __('Credits'); ?></a></li>
            <li id="version">
                <a href="https://www.cipherguard.com/credits" class="tooltip-left" data-tooltip="<?= $version; ?>">
